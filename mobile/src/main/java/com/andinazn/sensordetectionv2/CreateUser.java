...
public class CreateUser {
    ...
    public CreateUser(String name, int age, String email, String password, String code, String isSharing, String lat, String lng, String userid, int tmpHr, String fallstate, String hrstate)
    {
        this.name = name;
        this.age = age;
        this.email = email;
